    ...
    <body>
        ...
        <main>
            <h1>Cereal con leche</h1>
            <hr>
            <div class='datos'>
                <p>Fecha de publicacion: 2024-05-23 08:04:17</p>
            ...
            <section>
                ...
                <div class='ingredient-container'>
                    ...
                    <li>Leche - 300 ml</li><li>Cereal - 300 g</li>
                    </ul>
                </div>
            </section>

            <section class='mainimage'>
                <img class='image' src='../fotosrecetas/2Cereals and Milk_1.png' alt=''>
            </section>
            ...
            <section>
                <div class='container-descripcion'>
                    <div class='recipe-description'> 
                        <h2>Descripción</h2>
                        <p>CEREAL PARA FINAL DE SEMESTRE
                        </p>
                    </div>
                </div>
            </section'>
            ...
            <section>
                <div class='container-descripcion'>
                    <div class='recipe-description'>
                        <h2>Procedimiento</h2>
                        <p>Sirve la leche y el cereal en un plato ondo.
                        </p>
                    </div>
                </div>
            </section'>
