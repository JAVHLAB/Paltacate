    ...
    <body>
        ...
        <main>
            ...
            <hr>
            <div class='datos'>
                <p>Fecha de publicacion: 2024-05-23 19:05:40</p>
                <p>Creador: salvando2024</p>
            </div>
            ...
            <section>
                ...
                <div class='ingredient-container'>
                    ...
                    <li>Cono Helado - 6 conos</li><li>Chocolate - 1 taza</li><li>Nuez - 1 taza</li><li>Fresas - 3 tazas</li>
                    </ul>
                </div>
            </section>

            <section class='mainimage'>
                <img class='image' src='../fotosrecetas/Conos.webp' alt=''>
            </section>
            ...
            <section>
                <div class='container-descripcion'>
                    <div class='recipe-description'> 
                        <h2>Descripción</h2>
                        <p>Las fresas con chocolate son el tipo de postre que nunca pasa de moda y hasta se venden ramos hechos con estas frutas. Para darle un giro a la versión clásica, servimos las fresas con chocolate en cono o barquillo para helado. ¡Le fascinarán a chicos y grandes!

¿Sabías qué? Las fresas son una fruta rica en nutrientes como vitamina C, antioxidantes, hierro, calcio, potasio y ácido fólico. ¿A ti te gustan las fresas?
                        </p>
                    </div>
                </div>
            </section'>
            ...
            <section>
                <div class='container-descripcion'>
                    <div class='recipe-description'>
                        <h2>Procedimiento</h2>
                        <p>Pasa el borde del cono sobre el chocolate y después por la nuez. Rellena con la crema de galleta, agrega las fresas y añade más chocolate y nuez.
                        </p>
                    </div>
                </div>
            </section'>
